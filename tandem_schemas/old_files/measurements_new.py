...
class EnvironmentalConditionsOutdoor(ArchiveSection):
    ...
    relative_humidity_min = Quantity(
        description='Minimum relative humidity during the activity.',
        type=float,
        unit='%',
        a_eln=ELNAnnotation(component='NumberEditQuantity', defaultDisplayUnit='%'),
    )
    ...
    relative_humidity_max = Quantity(
        description='Maximum relative humidity during the activity.',
        type=float,
        unit='%',
        a_eln=ELNAnnotation(component='NumberEditQuantity', defaultDisplayUnit='%'),
    )
    ...
    relative_humidity_average = Quantity(
        description='Average relative humidity during the activity.',
        type=float,
        unit='%',
        a_eln=ELNAnnotation(component='NumberEditQuantity', defaultDisplayUnit='%'),
    )    
...
class Preconditioning(ArchiveSection):
    ...
    # Subsections
    environmentalConditions = SubSection(
...
class EQEResults(ArchiveSection):
    ...
    eqe_onset = Quantity(
        ...
        unit='nn',
        a_eln=ELNAnnotation(
            component='NumberEditQuantity', defaultDisplayUnit='nn'),
    )
    ...
    eqe_max = Quantity(
        description='The maximum EQE value.',
        type=float,
        unit='%',
        a_eln=ELNAnnotation(component='NumberEditQuantity', defaultDisplayUnit='%'),
    )    
...
class StabilityDetails(ArchiveSection):
    ...
    potential_bias_regime = Quantity(
        ...
        type=MEnum(['Maximum_powerpoint_tracking',
                    'open_circuit',
                    'constant_potential', 
                    'constant_current',
                    'constant_resistance',
